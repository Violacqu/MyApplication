...
public class MainChart extends Activity {
    ...
    private static int[] COLORS = new int[] { Color.rgb(241,204,184), Color.rgb(242,240,191),
            Color.rgb(197,240,236), Color.rgb(196,239,207), Color.rgb(211,187,238), Color.rgb(240,157,129), Color.rgb(251,229,102) ,Color.rgb(214,129,98),Color.rgb(160,95,113),Color.rgb(207,106,63),Color.rgb(173,183,211),Color.rgb(189,210,151)};
    //double data[] = new double[] { 40, 50, 60, 70, 80, 90, 100 };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mLinear.setBackgroundColor(Color.rgb(255,255,255));
      ...
      //  mRenderer.setChartTitle("Expense");// 设置饼图标题
...
//        }
    ...
    class refreshTask extends AsyncTask<Void,Void,Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            MyListAdapter adapter = new MyListAdapter(MainChart.this,mySqlList);
            text_test1.setText(String.valueOf(pets));
